...
#define ACC_DENIED  42  // Output / Led Signal for Access denied
#define ACC_GRANTED 43  // Output / Led Signal Access granted

// If you connect a LED do not forget to add the resistor and GND connection.
